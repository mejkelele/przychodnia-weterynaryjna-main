...
export default async function MedicalHistoryPage({ params }: { params: { id: string } }) {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto p-8 my-8 bg-white shadow-lg rounded-xl border">
        <header className="border-b pb-6 mb-6 flex justify-between">
            <div>
                <h1 className="text-2xl font-bold text-gray-800">KARTA HISTORII CHOROBY</h1>
        ...
        <div className="space-y-6">
            {pet.visits.length === 0 ? (
                <p className="text-gray-500 italic text-center py-10">Brak wpisów w historii.</p>
            ) : (
